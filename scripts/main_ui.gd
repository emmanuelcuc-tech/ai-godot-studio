...
func _on_create() -> void:
	...
	var mode: String = "Modifying game" if AIOrchestrator.has_active_session() else "Creating game"
	_log("\n[b]%s:[/b] %s\n" % [mode, idea])
...
func _refresh_editors() -> void:
	for node in [library_tab, scripts_tab, animation_tab, controls_tab, effects_tab]:
